...
bool AppHelp::PrintOverview(bool with_title) {
  ...
  std::string column_1 =
      ...
      "\n    replaceAfter   - Replace after and including 1st occurrence of "
      "string"
      "\n    replaceAll     - Replace all occurrences of string"
      "\n    replaceBefore  - Replace before and including 1st occurrence of "
      "string"
      ...
      "\n    replaceAfterFromFile   - Replace after and including 1st "
      "occurrence of string from file"
      "\n    replaceAllFromFile     - Replace all occurrences of string from "
      "file"
      "\n    replaceBeforeFromFile  - Replace before and including 1st "
      "occurrence of string from file"
      "\n    replaceBetweenFromFile - Replace text between and including given "
      "strings from file"
      "\n    replaceFirstFromFile   - Replace first occurrence of string from "
      "file"
      "\n    replaceLastFromFile    - Replace last occurrence of string from "
      "file"
      "\n\n";
  ...
  std::string column_2 =
      ...
      "\n    getSchemeFromUrl - Extract scheme from given URL, "
      "e.g. http or https"
      "\n    getHostFromUrl   - Extract host from given URL, "
      "e.g. www.example.com"
      ...
      "\n    rand <from> <until> - Generate random number between <from> and "
      "<until>"
      "\n"
