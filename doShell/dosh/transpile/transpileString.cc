...
bool transpileString::TranspileExtractBetween(std::string *code) {
  return 0 < helper::String::ReplaceAll(code, "#extractBetween", "dosh extractBetween");
}

bool transpileString::TranspileReplaceAfter(std::string *code) {
  return 0 < helper::String::ReplaceAll(code, "#replaceAfter", "dosh replaceAfter");
}

bool transpileString::TranspileReplaceAll(std::string *code) {
  return 0 < helper::String::ReplaceAll(code, "#replaceAll", "dosh replaceAll");
}

bool transpileString::TranspileReplaceBefore(std::string *code) {
  return 0 < helper::String::ReplaceAll(code, "#replaceBefore", "dosh replaceBefore");
}
...
bool transpileString::TranspileReplaceFirst(std::string *code) {
  return 0 < helper::String::ReplaceAll(code, "#replaceFirst", "dosh replaceFirst");
}

bool transpileString::TranspileReplaceLast(std::string *code) {
  return 0 < helper::String::ReplaceAll(code, "#replaceLast", "dosh replaceLast");
}
