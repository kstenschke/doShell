...
| File                                                                                                                                    | Description                                                                                  |
| --------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [01_import.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/01_import.do.sh)                                           | Import scripts from other file                                                               |
| [02_macros.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/02_macros.do.sh)                                           | Use transpiler- and runtime macros                                                           |
| [03_platform_conditions.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/03_platform_conditions.do.sh)                 | Vary code per platform                                                                       |
| [04_random.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/04_random.do.sh)                                           | Random value generation                                                                      |
| [05_strings.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/05_strings.do.sh)                                         | String manipulation                                                                          |
| [06_strings_from_files.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/06_strings_from_files.do.sh)                   | Manipulation of strings from files                                                           |
| [07_clipboard_strings.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/07_clipboard_strings.do.sh)                     | Clipboard manipulation commands                                                              |
| [08_parse_url.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/08_parse_url.do.sh)                                     | Parse and encode/decode URL parts                                                            |
| [09_parse_php.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/09_parse_php.do.sh)                                     | Use PHP within doShell script                                                                |
| [10_runtime_variables.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/10_runtime_variables.do.sh)                     | Use of dynamic runtime variables                                                             |
| [11_dialogs_alert.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/11_dialogs_alert.do.sh)                             | Display an alert popup on the desktop                                                        |
| [12_dialogs_notify.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/12_dialogs_notify.do.sh)                           | Display a notification on the desktop                                                        |
| [13_dialogs_confirm.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/13_dialogs_confirm.do.sh)                         | Display and evaluate the choice of an ok- or cancel- confirmation popup on the desktop       |
| [14_dialogs_prompt.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/14_dialogs_prompt.do.sh)                           | Display and evaluate the input of a prompt popup on the desktop                              |
| [15_dialogs_select.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/15_dialogs_select.do.sh)                           | Display and evaluate the choice of a selection popup on the desktop                          |
| [16_perform_google_search.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/16_perform_google_search.do.sh)             | Open google in a new browser tab enter a search term and invoke search                       |
| [17_export_website_to_markdown.do.sh](https://github.com/kstenschke/doShell/blob/master/examples/17_export_website_to_markdown.do.sh)   | Get source HTML of website, convert (using Node.js) and output as markdown                   |
